...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('ws_products', function (Blueprint $table) {
            ...
            $table->tinyInteger('product_ordertype', false, true)->default('2')->comment('1:IN-STOCK, 2:PRE-ORDER');
            $table->smallInteger('product_minqty', false, true)->default('0')->comment('MIN ORDER QUANTITY');
            $table->smallInteger('product_maxqty', false, true)->default('0');
            ...
            $table->string('product_related', 1024)->nullable();
