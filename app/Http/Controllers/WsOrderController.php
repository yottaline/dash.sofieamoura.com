    ...
    public function submit(Request $request)
    {
        ...
        if(!count($retailer))
        {
            $retailerParam = [
                ...
                'retailer_phone'    => $request->r_phone,
                'retailer_country'  => 1,
                'retailer_city'     => $request->r_city,
                'retailer_address'  => $request->address,
                'retailer_company'  => 'Company',
                'retailer_created'  => Carbon::now(),
                'retailer_province' => $request->r_city,
            ];
        ...
        if($request->checkbox == 'false')
        {
            ...
            'order_bill_zip'      => $retailer[0]->retailer_country,
            'order_bill_line1'    => $retailer[0]->retailer_city,
            'order_bill_line2'    => $retailer[0]->retailer_city,
            ...
            'order_ship_zip'      => $retailer[0]->retailer_country,
            'order_ship_line1'    => $retailer[0]->retailer_city,
            'order_ship_line2'    => $retailer[0]->retailer_city,
